...
METHODS="${METHODS:-raw_no_correction,HalluGuard-LRBN,RevIN,DishTS,SAN,NST,SoP-step-wise,SoP-variable-wise,SOLID-official-supported,matched_sparse_smoothing,naive_smoothing,ema_smoothing,median_smoothing}"
