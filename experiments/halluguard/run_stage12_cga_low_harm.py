#!/usr/bin/env python
"""Run Stage 12 CGA low-harm compact priority validation."""
...
from halluguard_stage12_cga_low_harm import build_all_artifacts
...
DEFAULT_OUTPUT = Path("experiments/halluguard/results/stage12_cga_low_harm")
