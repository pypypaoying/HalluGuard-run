#!/usr/bin/env python
"""Run Stage 15 endogenous low-harm editor compact validation."""
...
from halluguard_stage15_endogenous_editors import build_all_artifacts
...
DEFAULT_OUTPUT = Path("experiments/halluguard/results/stage15_endogenous_editors")
