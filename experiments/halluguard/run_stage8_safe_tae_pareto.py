#!/usr/bin/env python
"""Run Stage 8 Safe-TAE Pareto compact validation."""
...
from halluguard_stage8_safe_tae_pareto import build_all_artifacts
...
DEFAULT_OUTPUT = Path("experiments/halluguard/results/stage8_safe_tae_pareto")
...
def main() -> None:
    ...
    print(json.dumps(result["verdict"], indent=2, ensure_ascii=False, default=json_default))
