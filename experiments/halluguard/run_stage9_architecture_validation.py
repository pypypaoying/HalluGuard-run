#!/usr/bin/env python
"""Run Stage 9 large-architecture compact validation."""
...
from halluguard_stage9_architecture_validation import build_all_artifacts
...
DEFAULT_OUTPUT = Path("experiments/halluguard/results/stage9_architecture_validation")
