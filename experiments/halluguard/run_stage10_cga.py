#!/usr/bin/env python
"""Run Stage 10 CGA compact validation."""
...
from halluguard_stage10_cga import build_all_artifacts
...
DEFAULT_OUTPUT = Path("experiments/halluguard/results/stage10_cga")
