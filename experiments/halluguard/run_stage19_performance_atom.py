#!/usr/bin/env python
"""Run Stage19 Residual Quantile / Non-Boundary Shape Atom validation."""
...
from halluguard_stage19_performance_atom import Stage19Config, build_all_artifacts
...
DEFAULT_OUTPUT = Path("experiments/halluguard/results/stage19_performance_atom_validation")
...
def main() -> None:
    ...
    parser.add_argument("--n-pca-basis", type=int, default=5)
    parser.add_argument("--n-dct-basis", type=int, default=8)
    args = parser.parse_args()
    cfg = Stage19Config(
        seed=args.seed,
        bootstrap=args.n_bootstrap,
        output_dir=str(args.output_dir),
        n_pca_basis=args.n_pca_basis,
        n_dct_basis=args.n_dct_basis,
    )
