#!/usr/bin/env python
"""Run Stage 13 CGA decision-geometry compact validation."""
...
from halluguard_stage13_cga_decision_geometry import build_all_artifacts
...
DEFAULT_STAGE8 = Path("experiments/halluguard/results/stage8_safe_tae_pareto")
DEFAULT_STAGE3 = Path("experiments/halluguard/results/lrbn_bp_stage3")
DEFAULT_OUTPUT = Path("experiments/halluguard/results/stage13_cga_decision_geometry")
...
def main() -> None:
    ...
    parser.add_argument("--stage8-dir", type=Path, default=DEFAULT_STAGE8)
