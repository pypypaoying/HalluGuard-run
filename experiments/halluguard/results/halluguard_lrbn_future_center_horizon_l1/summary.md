...
- `future_center_horizon_conservative` / `DLinear`: completed 8 / 8, mean MSE 5.654910424421468, mean MAE 1.8086466904437828, mean MSE delta vs raw -27.58537400247382, blocked 0
- `future_center_horizon_conservative` / `PatchTST`: completed 8 / 8, mean MSE 5.841037693164186, mean MAE 1.8532241105756713, mean MSE delta vs raw 0.014842828222198429, blocked 0
...
- `future_center_horizon_conservative` / `ALL`: completed 16 / 16, mean MSE 5.747974058792826, mean MAE 1.8309354005097271, mean MSE delta vs raw -13.785265587125812, blocked 0
