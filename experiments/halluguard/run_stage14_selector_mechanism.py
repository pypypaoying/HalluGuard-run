#!/usr/bin/env python
"""Run Stage 14 selector-mechanism compact validation."""
...
from halluguard_stage14_selector_mechanism import build_all_artifacts
...
DEFAULT_OUTPUT = Path("experiments/halluguard/results/stage14_selector_mechanism")
